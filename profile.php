<?php
	...
	if(isset($_SESSION['user']['id'])){
		if(!(isset($_SESSION['user']['name']))){
			...
			if ($result->num_rows > 0) {
			    while ($row = $result->fetch_assoc()) {
					$_SESSION['charities']['myLocation'][$row['id']] = $row;
			...
			if ($result->num_rows > 0) {
			    while ($row = $result->fetch_assoc()) {
					$_SESSION['charities']['notMyLocation'][$row['id']] = $row;
					$_SESSION['categories'][$row['Category']]['charities'][] = $row['id'];
				}
			} else {
				$error = TRUE;
			...
			foreach ($_SESSION['sort'] as $key => $value) {
				...
				<article id='a". $key ."' class = 'hidden'>";
					...
					if (isset($_SESSION['charities']['myLocation'][$id])) {
						...
						echo "<div class='charity'>
							 <fieldset><legend>" . $_SESSION['charities']['myLocation'][$id]['name'] . "</legend><table>
							 <tr><td>Address: </td> <td>" . $_SESSION['charities']['myLocation'][$id]['Addres'] ."</td></tr>
							 <tr><td>Phone: </td> <td>" . $_SESSION['charities']['myLocation'][$id]['phone'] ."</td></tr>
							 <tr><td>Website: </td> <td> <a href='". $_SESSION['charities']['myLocation'][$id]['Website'] ."' >" . $_SESSION['charities']['myLocation'][$id]['Website'] ."</td></tr>
							 <tr><td>Activites: </td> <td>" . $_SESSION['charities']['myLocation'][$id]['activity'] ."</td></tr>
							 </table>
				...
				foreach ($_SESSION['categories'][$key]['charities'] as $id) {
					if (isset($_SESSION['charities']['notMyLocation'][$id])) {
						...
						echo "<div class='charity'>
							 <fieldset><legend>" . $_SESSION['charities']['notMyLocation'][$id]['name'] . "</legend><table>
							 <tr><td>Address: </td> <td>" . $_SESSION['charities']['notMyLocation'][$id]['Addres'] ."</td></tr>
							 <tr><td>Phone: </td> <td>" . $_SESSION['charities']['notMyLocation'][$id]['phone'] ."</td></tr>
							 <tr><td>Website: </td> <td> <a href='". $_SESSION['charities']['notMyLocation'][$id]['Website'] ."' >" . $_SESSION['charities']['notMyLocation'][$id]['Website'] ."</td></tr>
							 <tr><td>Activites: </td> <td>" . $_SESSION['charities']['notMyLocation'][$id]['activity'] ."</td></tr>
							 </table>
							 <form action='bookmark.php' method='POST' target='_blank'>
							 <input type='hidden' name='id' value='". $id ."' >
							 <button class='bookmark' id='c". $id ."' >" . $btt . "</button>
				...
				foreach ($_SESSION['bookmarks']['id'] as $id) {
					if (isset($_SESSION['charities']['myLocation'][$id])) {
						echo "<div class='charity'>
							 ...
							 <form action='bookmark.php' method='POST' target='_blank'>
							 <input type='hidden' name='id' value='". $id ."' >
							 <button class='bookmark' id='c". $id ."' >Remove from bookmarks</button>
							 </form>
							 </fieldset>
							 </div>";
					}
